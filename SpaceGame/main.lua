...
function love.update(dt)
        ...
        engel.x = engel.x + spEng

        if engel.x == 1330 or engel.x == 10 then 
...
love.graphics.draw(sprites.uzayBackG, 0, 0)
love.graphics.draw(sprites.ship, ship.x - 24, 540)
love.graphics.draw(sprites.dusman, dusman.x - 24, 25)
